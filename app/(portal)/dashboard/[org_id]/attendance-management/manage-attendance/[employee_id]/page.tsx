...
function mobileStatusBadgeCls(status: string | undefined): string {
  ...
  if (value === "late") return "bg-[#FEF3E6] text-[#E8710A]";
  if (value === "leave") return "bg-[#FCE8E6] text-[#D93025]";
  if (value === "half_day") return "bg-[#E8F4FB] text-[#008CD3]";
  if (value === "short_leave") return "bg-[#FFF8E1] text-[#F9A825]";
  ...
  return (
    <div className="min-h-full bg-[#F5F7FA] lg:bg-transparent">
      ...
      <div className="lg:hidden">
          ...
          <div className="flex items-center gap-2 px-3 py-3">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="truncate text-[13px] text-[#6B7280]">
                {loading
                  ? "Loading…"
                  : `${rows.length} record${rows.length === 1 ? "" : "s"} · ${profile?.user_role_name || "employee"}`}
              </p>
            </div>
            <button
              type="button"
        ...
        {!loading && !error && rows.length > 0 && mobileMainTab === "overview" ? (
        ...
        {!loading && !error && rows.length > 0 && mobileMainTab === "insights" ? (
          <div className="space-y-3 p-4">
            <div className="rounded-xl border border-[#E4E7EC] bg-white p-4 shadow-sm">
        ...
        {!loading && !error && rows.length > 0 && mobileMainTab === "log" ? (
